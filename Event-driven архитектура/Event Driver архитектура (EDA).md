...
События подразделяются на сервисные (стриминги) и бизнесовые.

## Coupling и cohesion
Любая система - это набор элементов и связи между ними. Так например автомобиль является полноценной системой состоящей из колес, кузова, двигателя итд.
