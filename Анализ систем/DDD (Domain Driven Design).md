...
В отличии от ES в рамках стратегического DDD анализ системы базируется на глобальных целях бизнеса. В [[Event Storming|Event Storming]] используется другой подход – анализ систем базируется на событиях.
![[DDD vs ES.png|250]]

Основные концепции стратегического DDD:
